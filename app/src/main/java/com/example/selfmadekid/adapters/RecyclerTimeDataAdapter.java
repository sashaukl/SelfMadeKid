...
public class RecyclerTimeDataAdapter extends RecyclerView.Adapter<RecyclerTimeDataAdapter.ViewHolder> {
    ...
    public RecyclerTimeDataAdapter(Context context, ArrayList<ChildTask> arrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_HEADER:
                v = mInflater.inflate(R.layout.date_picker, parent, false);
                break;
            default:
                v = mInflater.inflate(R.layout.date_picker, parent, false);
        }
